...
import (
	...
	"github.com/TomorrowWu/gforge/internal/dao"
	"github.com/TomorrowWu/gforge/internal/schema"
...
var daoCommand = &cli.Command{
	...
	Fn: func(ctx *cli.Context) error {
		...
		io.Copy(&buff, addImport(arg.DBName))
		structName, err := getSchema(&buff, arg)
		if nil != err {
			return err
		}
		r, err := dao.GenerateDao(arg.DBName,arg.TableName, structName)
		if nil != err {
			return err
		}
